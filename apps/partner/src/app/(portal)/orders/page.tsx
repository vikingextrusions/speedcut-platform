  ...
  return (
    <div style={{ animation: 'fade-in 0.3s ease-out' }}>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--text-muted)', marginTop: '0.25rem' }}>Orders assigned to your organisation</p>
      </div>
      ...
      <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
        {orders && orders.length > 0 ? (
          ...
          <div style={{ padding: '4rem 2rem', textAlign: 'center' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>Orders will appear here once assignments are accepted and confirmed</p>
          </div>
        )}
      </div>
    </div>
